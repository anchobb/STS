...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.rememberMeParameter("remember-me") //서버를 끄게 되면 remember-me가 사라지므로, DB와 연결해서 로그인정보를 저장해야 remember-me 가능~
...
//			.roles("ADMIN");
	...
	//토큰 저장 Bean (remember-me를 DB에 넣어주기 위해서!) 위에 Autowired로 datasource2 의존주입해서 setDataSource에 객체 넣기!
	@Bean
